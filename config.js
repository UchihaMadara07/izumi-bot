...
module.exports = {
  ...
  MENU_URL: process.env.MENU_URL || "https://files.catbox.moe/zk7ltq.jpeg",
  CAPTION: process.env.CAPTION || "𝗢𝗕𝗜𝗧𝗢-𝗕𝗢𝗧𝗭𝗭",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "★ σвιтσ-кυη ★",
  BOT_NAME: process.env.BOT_NAME || "𝗢𝗕𝗜𝗧𝗢-𝗕𝗢𝗧𝗭𝗭",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "★ σвιтσ-кυη ★,🇮🇳🍁",
  AUDIO_DATA: process.env.AUDIO_DATA || "★ σвιтσ-кυη ★;🇮🇳🍁;https://files.catbox.moe/zk7ltq.jpeg",
  PROCESSNAME: process.env.PROCESSNAME || "★ σвιтσ-кυη ★",
  AUTHOR: process.env.AUTHOR || "★ σвιтσ-кυη ★",
