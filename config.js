...
module.exports = {
  ...
  MENU_URL: process.env.MENU_URL || "https://cdn.ironman.my.id/i/ro2o2k.jpg",
  CAPTION: process.env.CAPTION || "Made with 🤍",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "★ σвιтσ-кυη ★",
  BOT_NAME: process.env.BOT_NAME || "ᴏʙɪᴛᴏ ᴜᴄʜɪʜᴀ",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "★ σвιтσ-кυη ★,🇮🇳🍁",
  AUDIO_DATA: process.env.AUDIO_DATA || "★ σвιтσ-кυη ★;ᴏʙɪᴛᴏ ᴜᴄʜɪʜᴀ;https://cdn.ironman.my.id/i/ro2o2k.jpg",
